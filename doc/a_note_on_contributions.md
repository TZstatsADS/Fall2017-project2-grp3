...
[Contribution Statement] 
  ...
  + Hongyang Yang obtained detailed natural disaster data from data.gov; combined, cleaned, and preprocessed 4 years data (208,739 obs, 14 variables); designed and developed the interactive map to monitor different type of disasters by state and month; updated data and readme files, deployed the final shiny app.
